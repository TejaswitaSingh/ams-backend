...
const AdminPrimarySchema = new mongoose.Schema(
    {
        firstName: {
            type: String,
            required: true,
...
AdminPrimarySchema.pre('save', function(next) {
    if (!this.username) {
...
const adminPrimaryModel = mongoose.model('AdminPrimary', AdminPrimarySchema);

module.exports = adminPrimaryModel;